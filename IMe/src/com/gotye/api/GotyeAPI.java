...
public final class GotyeAPI {
	 ...
	 * @param listener
	 */
	public void addListerer(GotyeListener listener) {
	...
	public void serviceDestoryNotify() {
		context.startService(new Intent(context, GotyeService.class));
	}
	 ...
	 * @return
	 */
	public int modifyUserInfo(GotyeUser forModify, String path) {
 ...
 */
	 ...
	 * @return 请求状态
	 */
	public int decodeMessage(GotyeMessage meessage) {
		return decodeMessage(meessage.getDbId());
	}
