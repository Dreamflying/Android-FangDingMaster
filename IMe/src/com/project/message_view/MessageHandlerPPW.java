...
public class MessageHandlerPPW {
	...
	public static void startPopWin(final Context mContent, View v,
			final IApply iApply,final int position,int image) {
		content = mContent;
		LayoutInflater inflater = LayoutInflater.from(mContent);
		View view = inflater.inflate(R.layout.message_handler_ppw, null);
		...
		cll.setBackgroundResource(image);
