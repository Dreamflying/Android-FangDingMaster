...
public class MainListView extends ListView implements OnScrollListener {
	...
	private final static int DONE = 3;// 加载完成？
	...
	this.context=context;
		// setCacheColorHint(context.getResources().getColor(0x00000000));
		inflater = LayoutInflater.from(context);
		headerView = (LinearLayout) inflater.inflate(R.layout.view_refresh_head, null);
		...
		processImageView=(ImageView)headerView.findViewById(R.id.processimage);
		// 设置下拉刷新图标的最小高度和宽度
	...
	public void changeHeaderViewByState() {
		...
		case REFRESHING:
			...
			processImageView.setVisibility(View.VISIBLE);
			Animation hyperspaceJumpAnimation = AnimationUtils.loadAnimation(
					context, R.anim.loading_animation);
			// 使用ImageView显示动画
			processImageView.startAnimation(hyperspaceJumpAnimation);
			lvHeaderArrowIv.clearAnimation();
		...
		case DONE:
			...
			processImageView.setVisibility(View.GONE);
			lvHeaderArrowIv.clearAnimation();
			lvHeaderArrowIv.setImageResource(R.drawable.jiantou);
			lvHeaderTipsTv.setText("下拉刷新");
			//lvHeaderLastUpdatedTv.setVisibility(View.VISIBLE);
			break;
		}
	...
	public void onRefreshComplete() {
		state = DONE;
		//lvHeaderLastUpdatedTv.setText("最近更新:" + new Date().toGMTString());
		lvHeaderLastUpdatedTv.setVisibility(View.GONE);
		changeHeaderViewByState();
	}
	...
	public void setAdapter(IwantAndIhaveListAdapter adapter) {
		//lvHeaderLastUpdatedTv.setText("最近更新:" + new Date().toGMTString());
		lvHeaderLastUpdatedTv.setVisibility(View.GONE);
