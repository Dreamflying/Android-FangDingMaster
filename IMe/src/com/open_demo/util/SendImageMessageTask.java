...
public class SendImageMessageTask extends AsyncTask<String, String, String> {
	...
	private void sendImageMessage(String imagePath) {
		...
		createMessage.putExtraData(StringUtils.stringToByteArray(SharePreferenceUtils.getIntance(chatPage).getCurrentNickName()+"@"+SharePreferenceUtils.getIntance(chatPage).getHeadImgUserName()+"@"+SharePreferenceUtils.getIntance(chatPage).getCurrentIdio()));
