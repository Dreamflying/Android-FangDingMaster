...
public class GotyeService extends Service implements NotifyListener {
	...
	public void onCreate() {
		...
		LocationUtils.getInstance(GotyeService.this)
	...
	private void notify(String msg) {
		...
		Notification notification = new Notification(R.drawable.new_logo,
				getString(R.string.app_name), System.currentTimeMillis());
		notification.flags = Notification.FLAG_AUTO_CANCEL;
		Intent intent = new Intent(this, NewMainTabActivity.class);
	...
	public void onReceiveMessage(int code, GotyeMessage message, boolean unRead) {
		...
		notify(SQLDatebaseUtils.getInstance(GotyeService.this).getNickNameByUsername(msg));
	}
